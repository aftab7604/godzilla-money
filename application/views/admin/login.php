...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet"
        href="<?php echo base_url();?>admin_assets/bower_components/bootstrap/dist/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet"
        href="<?php echo base_url();?>admin_assets/bower_components/font-awesome/css/font-awesome.min.css">
    <!-- Ionicons -->
    ...
    <div class="login-box" style="margin: 8% auto;">    
        ...
        <div class="login-box-body">
            ...
            <p class="login-box-msg"
                style="padding: 7px 20px 7px 20px; background-color: #bc3c3c; margin-bottom: 9px; color: #fff;">
                <?php echo $msg; ?>
            </p>
            <?php } ?>
            <p class="login-box-msg" style="padding: 7px 20px 7px 20px; background-color: #3c8dbc; margin-bottom: 9px; color: #fff;">Admin Login</p>
            <!--  <p class="login-box-msg" style="padding: 7px 20px 7px 20px; margin-bottom: 9px; color:#ff0000;"><?php echo @$error_message; ?></p> -->
