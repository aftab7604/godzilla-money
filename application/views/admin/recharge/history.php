...
<div class="wrapper">   
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Recharge History<small>Control panel</small></h1>
            <ol class="breadcrumb">
                ...
                <div class="col-md-12">
                    <div id="listGroup" class="box box-info">
                        <div class="box-header with-border">
                            ...
                            <div class="col-md-12">
                                <form action="<?php echo base_url("admin/recharge-history");?>" method="get">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-grup">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-grup">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    ...
                                                    <option value="2" <?php echo $this->input->get('status') == 2 ? 'selected' : ''; ?>>Deposited</option>
                                                    <option value="3" <?php echo $this->input->get('status') == 3 ? 'selected' : ''; ?>>Rejected</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <a href="<?php echo base_url("admin/recharge-history");?>" class="btn btn-warning" style="margin-top:25px;">Reset</a>
                                        </div>
                                    </div>                                  
                                </form>
                            </div>
                                    ...
                                    <table id="datatable" class="display table table-bordered table-striped table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="text-info" target="_blank" href="<?php echo base_url("uploads/user/payment_proof/".$v['proof_img']);?>">View Image</a></td>
